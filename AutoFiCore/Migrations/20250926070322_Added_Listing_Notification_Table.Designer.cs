...
namespace AutoFiCore.Migrations
{
    ...
    [Migration("20250926070322_Added_Listing_Notification_Table")]
    partial class Added_Listing_Notification_Table
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AutoFiCore.Models.AuctionWinners", b =>
                {
                    b.Property<int>("AuctionId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AutoFiCore.Models.ListingNotification", b =>
                {
                    b.Property<int>("VehicleId")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("ListingNotifications");
                });
            ...
            modelBuilder.Entity("AutoFiCore.Models.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AutoFiCore.Models.VehicleFeatures", b =>
                {
                    b.Property<string>("Make")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
                    ...
                    b.HasIndex("Drivetrain")
                        .HasDatabaseName("IX_VehicleFeatures_Drivetrain");

                    b.HasIndex("Engine")
                        .HasDatabaseName("IX_VehicleFeatures_Engine");

                    b.HasIndex("Make")
                        .HasDatabaseName("IX_VehicleFeatures_Make");

                    b.HasIndex("Model")
                        .HasDatabaseName("IX_VehicleFeatures_Model");

                    b.HasIndex("Year")
                        .HasDatabaseName("IX_VehicleFeatures_Year");
